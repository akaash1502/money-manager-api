    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : allProfiles){
            String body = "Hi " + profile.getFullname() + ",<br><br>"
                    + "This is a friendly reminder to add your income and expesnes for today in Money Manager. <br>"
                    ...
                    + "<br><br>Best Regards,<br>Money Manger Team";
    ...
    public void sendDailyExpenseSummary(){
        ...
        for(ProfileEntity profile : profiles){
            ...
            if(!todaysExpenses.isEmpty()){
                ...
                table.append("<tr style='background-color:#f2f2f2;'><th style= 'border:1px solid #ddd;padding:8px;'>Amount</th><th style= 'border:1px solid #ddd;padding:8px;'>Category</th></tr>");
                int i=1;
