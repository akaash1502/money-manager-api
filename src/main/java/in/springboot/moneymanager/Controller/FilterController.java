...
import in.springboot.moneymanager.dto.FilterDTO;
...
public class FilterController {
    ...
    @PostMapping("/filter")
    public ResponseEntity<?> filter(@RequestBody FilterDTO filter){
        ...
        if("income".equalsIgnoreCase(filter.getType())){
            ...
            ResponseEntity.badRequest().body("Invalid type. Must of 'expense' or 'income' type");
        }
        return null;
    }
}
